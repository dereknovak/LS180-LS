-- A result from:
-- $ pg_dump -d postgres -t weather --inserts > problem11.sql
...
--
-- Name: weather; Type: TABLE; Schema: public; Owner: dereknovak
--
...
ALTER TABLE public.weather OWNER TO dereknovak;

--
-- Data for Name: weather; Type: TABLE DATA; Schema: public; Owner: dereknovak
--
